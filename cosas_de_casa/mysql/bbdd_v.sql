...
CREATE TABLE BILLETE(
    ...
    CONSTRAINT codcomp_billete_FK FOREIGN KEY (codcompania) REFERENCES COMPANIA(codcompania) ON UPDATE CASCADE,
/*  CONSTRAINT de_FK FOREIGN KEY (de) REFERENCES AEROPUERTO(ciudad) ON UPDATE CASCADE,*/
    CONSTRAINT hacia_ciudad_FK FOREIGN KEY (ciudad) REFERENCES AEROPUERTO(ciudad) ON UPDATE CASCADE,
